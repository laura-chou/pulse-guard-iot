...
def main():
    ...
    if raw_df.empty:
        ...
        with tab1:
            ...
            st.plotly_chart(build_bpm_chart(df, t), use_container_width=True)

            st.subheader(t['spo2_trend_title'])
            st.plotly_chart(build_spo2_chart(df, t), use_container_width=True)
