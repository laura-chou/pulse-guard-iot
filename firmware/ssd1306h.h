...
class SSD1306 {
  ...
  public:
    ...
    void drawVLine(uint8_t x, uint8_t y, uint8_t h1); 
    ...
    void drawChar(int x, int y,  unsigned char c, const int BIG);
    void drawStr(int x, int y, const char *s, int BIG);
    void drawStr(int x, int y, const __FlashStringHelper *s, const int BIG);
    void firstPage(void);
    bool nextPage(void);
    void off();
    void on();
