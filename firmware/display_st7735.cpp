...
static const uint8_t o2_bits[] PROGMEM = { 0x80, 0x01, 0xc0, 0x03, 0xe0, 0x07, 0xf0, 0x0f, 0x38, 0x1e, 0x1c, 0x3c, 0x0c, 0x38,  0x0e, 0x70, 0x0e, 0x70, 0x1e, 0x70, 0x7e, 0x78, 0xfc, 0x3f, 0xfc, 0x3f, 0xf8, 0x1f, 0xe0, 0x07, 0x00, 0x00 };
...
void DisplayManager::updateScreen(int msg, int beatAvg, int SPO2, DeviceStatus currentStatus, uint32_t totalFingerSeconds, uint32_t fingerOnStartTime) {
    if (msg != last_msg) {
        ...
        if (msg == 2) { // Measuring screen Layout
            ...
            tft.drawXBitmap(107, 109, o2_bits, 16, 16, ST7735_CYAN);
            tft.setTextSize(1); tft.setTextColor(ST7735_CYAN, ST7735_BLACK);
